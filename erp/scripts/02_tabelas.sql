...
CREATE TABLE TB_CIDADES
	...
	CONSTRAINT FK_CID1 FOREIGN KEY (COD_UF) REFERENCES TB_UF(COD_UF)
	);
...
CREATE TABLE TB_CLIENTES
	...
	COD_PAGTO INT ,
    CONSTRAINT FK_COD_EMP1 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA),
	CONSTRAINT FK_CLI1 FOREIGN KEY (COD_CIDADE) REFERENCES TB_CIDADES(COD_CIDADE)
	);
...
(   COD_EMPRESA INT NOT NULL,
	...
	DATA_CADASTRO DATE NOT NULL,
	COD_PAGTO INT ,
    CONSTRAINT FK_COD_EMP2 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA),
	CONSTRAINT FK_FOR1 FOREIGN KEY (COD_CIDADE) REFERENCES TB_CIDADES(COD_CIDADE)
	);
...
CREATE TABLE TB_MATERIAL
    ...
    CONSTRAINT FK_COD_EMP3 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA),
	CONSTRAINT FK_MAT1 FOREIGN KEY (COD_TIP_MAT) REFERENCES TB_TIPO_MAT(COD_TIP_MAT),
    CONSTRAINT PK_EMP_MAT PRIMARY KEY (COD_EMPRESA,COD_MAT)
	);


    
CREATE TABLE TB_MAT_FORNEC
(
    COD_EMPRESA INT NOT NULL,
    COD_MAT INT NOT NULL,
    ID_FOR INT NOT NULL,
    CONSTRAINT PK_MAT_FOR PRIMARY KEY (COD_EMPRESA,COD_MAT,ID_FOR),
    CONSTRAINT FK_MAT_FOR1 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA),
    CONSTRAINT FK_MAR_FOR2 FOREIGN KEY (ID_FOR) REFERENCES TB_FORNECEDORES(ID_FOR)
    );

--CRIANDO INDEX
--SIMULA ERRO INDEX DE CHAVE PRIMARIA
--CREATE INDEX IX_MAT1 ON TB_MATERIAL(COD_EMPRESA,COD_MAT);
--CRIANDO INDEX TIPO MAT
CREATE INDEX IX_MAT2 ON TB_MATERIAL(COD_TIP_MAT);

	
--PRODUCAO
CREATE TABLE TB_ORDEM_PROD
	(
    COD_EMPRESA INT NOT NULL,
    ...
    CONSTRAINT FK_OP1 FOREIGN KEY (COD_MAT_PROD,COD_EMPRESA) REFERENCES TB_MATERIAL(COD_MAT,COD_EMPRESA)
...
CREATE TABLE TB_APONTAMENTOS
    ...
    CONSTRAINT FK_AP1 FOREIGN KEY (COD_MAT_PROD,COD_EMPRESA) REFERENCES TB_MATERIAL(COD_MAT,COD_EMPRESA),
	CONSTRAINT FK_APON1 FOREIGN KEY (ID_ORDEM) REFERENCES TB_ORDEM_PROD(ID_ORDEM)
	);
...
(
	...
	CONSTRAINT FK_FIC1 FOREIGN KEY (COD_EMPRESA,COD_MAT_PROD) REFERENCES TB_MATERIAL(COD_EMPRESA,COD_MAT),
	CONSTRAINT FK_FIC2 FOREIGN KEY (COD_EMPRESA,COD_MAT_NECES) REFERENCES TB_MATERIAL(COD_EMPRESA,COD_MAT)
	);
    
-- CRIANDO SEQUENCIA PARA TABELA FICHA_TECNICA
CREATE SEQUENCE SEQ_FT START WITH 1 INCREMENT BY 1 NOMAXVALUE;

--CRIACAO DA TABELA CONSUMO -> o material consumido para cada apontamento
--DROP TABLE CONSUMO
...
(
	...
	CONSTRAINT FK_CONS1 FOREIGN KEY (COD_EMPRESA,COD_MAT_NECES) REFERENCES TB_MATERIAL(COD_EMPRESA,COD_MAT),
	CONSTRAINT FK_CONS2 FOREIGN KEY (ID_APON)  REFERENCES TB_APONTAMENTOS(ID_APON)
	);
...
CREATE TABLE TB_ESTOQUE
	...
	CONSTRAINT FK_EST1 FOREIGN KEY (COD_EMPRESA,COD_MAT) REFERENCES TB_MATERIAL(COD_EMPRESA,COD_MAT),
...
CREATE TABLE TB_ESTOQUE_LOTE
	...
	REFERENCES TB_MATERIAL(COD_EMPRESA,COD_MAT)
	);
...
--DROP TABLE ESTOQUE_MOV
	...
	CONSTRAINT FK_ESTM1 FOREIGN KEY (COD_EMPRESA,COD_MAT) REFERENCES TB_MATERIAL(COD_EMPRESA,COD_MAT)
...
CREATE TABLE TB_PED_COMPRAS
	...
	CONSTRAINT FK_PEDC1 FOREIGN KEY (ID_FOR) REFERENCES TB_FORNECEDORES(ID_FOR),
    CONSTRAINT PK_PEDC1 PRIMARY KEY (COD_EMPRESA,NUM_PEDIDO)
	);
    
    -- CRIACAO DE TABELA DE PARAMETROS DE NUMEROS DE PEDIDO POR EMPRESA
    CREATE TABLE TB_PARAM_PED_COMPRAS
    (
     COD_EMPRESA INT NOT NULL PRIMARY KEY,
     NUM_PED INT NOT NULL,
     CONSTRAINT FK_PPC FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA)
     );
     
--CRIACAO DA TABELA PEDIDO COMPRAS
CREATE TABLE TB_PED_COMPRAS_ITENS
	(
    COD_EMPRESA INT NOT NULL,
	NUM_PEDIDO INT NOT NULL,
	...
	CONSTRAINT FK_PEDIT1 FOREIGN KEY (COD_EMPRESA,NUM_PEDIDO) REFERENCES TB_PED_COMPRAS(COD_EMPRESA,NUM_PEDIDO),
	CONSTRAINT FK_PEDIT2 FOREIGN KEY (COD_EMPRESA,COD_MAT) REFERENCES TB_MATERIAL(COD_EMPRESA,COD_MAT),
...
CREATE TABLE TB_CENTRO_CUSTO
    ...
    CONSTRAINT FK_CC1  FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA),
...
CREATE TABLE TB_CARGOS 
	(COD_EMPRESA INT NOT NULL,
     ...
     CONSTRAINT FK_CARG1  FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA),
...
CREATE TABLE TB_FUNCIONARIO 
	...
	COD_CARGO INT NOT NULL,
	CONSTRAINT FK_FUNC1 FOREIGN KEY (COD_EMPRESA,COD_CC) REFERENCES TB_CENTRO_CUSTO(COD_EMPRESA,COD_CC),
	CONSTRAINT FK_FUNC2 FOREIGN KEY (COD_CIDADE) REFERENCES TB_CIDADES(COD_CIDADE),
	CONSTRAINT FK_FUNC3 FOREIGN KEY (COD_EMPRESA,COD_CARGO) REFERENCES TB_CARGOS(COD_EMPRESA,COD_CARGO),
    CONSTRAINT PK_FUNC1 PRIMARY KEY(COD_EMPRESA,MATRICULA)
    );

-- TABELAS DE PARAMETROS DE MATRICULA POR EMPRESA
 CREATE TABLE TB_PARAM_MATRICULA
  (
   COD_EMPRESA INT NOT NULL PRIMARY KEY,
   MATRICULA INT NOT NULL,
   CONSTRAINT FK_PMAT1 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA)
   );
...
CREATE TABLE TB_SALARIO
	...
	CONSTRAINT FK_SAL1 FOREIGN KEY (COD_EMPRESA,MATRICULA) REFERENCES TB_FUNCIONARIO(COD_EMPRESA,MATRICULA),
    CONSTRAINT PK_SAL1 PRIMARY KEY (COD_EMPRESA,MATRICULA) 
    );
--CRIACAO TABLE FOLHA DE PAGTO
--DROP TABLE FOLHA_PAGTO
CREATE TABLE TB_FOLHA_PAGTO
	(
    COD_EMPRESA INT NOT NULL,
	MATRICULA INT NOT NULL,
    ...
    CONSTRAINT FK_FP1 FOREIGN KEY (COD_EMPRESA,MATRICULA) REFERENCES TB_FUNCIONARIO(COD_EMPRESA,MATRICULA)
	);
    
-- CRIANDO INDEX PARA OTIMARIZAR CONSULTAS
CREATE INDEX IX1_FPAG ON TB_FOLHA_PAGTO(COD_EMPRESA,MES_REF,ANO_REF);
...
CREATE TABLE TB_USUARIOS
	...
	REFERENCES TB_FUNCIONARIO(COD_EMPRESA,MATRICULA),
    CONSTRAINT PK_USER PRIMARY KEY(COD_EMPRESA,MATRICULA)
	);
    
-- CRIANDO INDEX UNIQUE PARA LOGIN
CREATE UNIQUE INDEX IX1_USER ON TB_USUARIOS (LOGIN);
...
CREATE TABLE TB_CONTAS_RECEBER
	...
	DATA_PAGTO DATE,
	VALOR DECIMAL(10,2),
	CONSTRAINT FK_CR1 FOREIGN KEY (ID_CLIENTE) REFERENCES TB_CLIENTES(ID_CLIENTE),
    CONSTRAINT FK_CR2 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA)
	);
...
CREATE TABLE TB_CONTAS_PAGAR
	...
	DATA_PAGTO DATE ,
	VALOR DECIMAL(10,2),
	CONSTRAINT FK_CP1 FOREIGN KEY (ID_FOR) REFERENCES TB_FORNECEDORES(ID_FOR),
    CONSTRAINT FK_CP2 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA)
	);
...
CREATE TABLE TB_COND_PAGTO_DET
	(
	...
	REFERENCES TB_COND_PAGTO(COD_PAGTO)
	);

--COMERCIAL
--CRIACAO TABELA PEDIDO DE VENDAS
CREATE TABLE TB_PED_VENDAS
	(
    COD_EMPRESA INT NOT NULL,
	NUM_PEDIDO INT  NOT NULL,
	ID_CLIENTE INT NOT NULL,
	...
	SITUACAO NCHAR(1) NOT NULL, --A-ABERTO P-PLANEJADO -F FINALIZADO
	TOTAL_PED DECIMAL(10,2),
	CONSTRAINT FK_PV1 FOREIGN KEY (ID_CLIENTE)REFERENCES TB_CLIENTES(ID_CLIENTE),
	CONSTRAINT FK_PV2 FOREIGN KEY (COD_PAGTO) REFERENCES TB_COND_PAGTO(COD_PAGTO),
    CONSTRAINT FK_PV3 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA),
   ...
   -- CRIACAO DE TABELA DE PARAMETROS DE NUMEROS DE PEDIDO DE VENDAS POR EMPRESA
    CREATE TABLE TB_PARAM_PED_VENDAS
    (
     COD_EMPRESA INT NOT NULL PRIMARY KEY,
     NUM_PED INT NOT NULL,
     CONSTRAINT FK_PV FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA)
     );
    
--CRIACAO DA TABELA PEDIDO VENDAS ITENS
--DROP TABLE PED_VENDAS_ITENS
CREATE TABLE TB_PED_VENDAS_ITENS
	(
    COD_EMPRESA INT NOT NULL,
	NUM_PEDIDO INT NOT NULL,
	SEQ_MAT INT NOT NULL,
	...
	QTD     INT NOT NULL,
	VAL_UNIT DECIMAL(10,2) NOT NULL,
	CONSTRAINT FK_PVIT1 FOREIGN KEY (COD_EMPRESA,NUM_PEDIDO) REFERENCES TB_PED_VENDAS(COD_EMPRESA,NUM_PEDIDO),
    CONSTRAINT FK_PVIT2 FOREIGN KEY (COD_EMPRESA,COD_MAT) REFERENCES TB_MATERIAL(COD_EMPRESA,COD_MAT)
	);
...
CREATE TABLE TB_VENDEDORES
    (
	 ...
	 MATRICULA INT NOT NULL,
 	 CONSTRAINT FK_VEND1 FOREIGN KEY (COD_EMPRESA,MATRICULA) REFERENCES TB_FUNCIONARIO(COD_EMPRESA,MATRICULA),
...
CREATE TABLE TB_GERENTES
    ( COD_EMPRESA INT NOT NULL,
      ID_GER INT  NOT NULL,
	  MATRICULA INT NOT NULL,
 	CONSTRAINT FK_GER1 FOREIGN KEY (COD_EMPRESA,MATRICULA) REFERENCES TB_FUNCIONARIO(COD_EMPRESA,MATRICULA),
...
CREATE TABLE TB_CANAL_VENDAS_G_V
	(
    COD_EMPRESA INT NOT NULL,
	ID_GER INT NOT NULL,
	--ID do Vendedor
	ID_VEND INT NOT NULL,
    CONSTRAINT FK_CGV3 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA)
	);
    

--CANAL DE VENDAS RELACIONA VENDEDOR COM CLIENTE
--DROP TABLE CANAL_VENDAS_V_C
CREATE TABLE TB_CANAL_VENDAS_V_C
	(
    COD_EMPRESA INT NOT NULL,
	ID_VEND INT NOT NULL,
	ID_CLIENTE INT NOT NULL,
	CONSTRAINT FK_CVC2 FOREIGN KEY (ID_CLIENTE) REFERENCES TB_CLIENTES(ID_CLIENTE),
    CONSTRAINT FK_CCV1 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA) 
	);
...
CREATE TABLE TB_META_VENDAS
	...
	VALOR DECIMAL(10,2),
	CONSTRAINT FK_MV1 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA)
	);
...
CREATE TABLE TB_NOTA_FISCAL
	...
	CONSTRAINT FK_NF1 FOREIGN KEY (COD_CFOP) REFERENCES TB_CFOP(COD_CFOP),
	CONSTRAINT FK_NF2 FOREIGN KEY (COD_PAGTO) REFERENCES TB_COND_PAGTO(COD_PAGTO),
...
CREATE TABLE TB_NOTA_FISCAL_ITENS
	...
	CONSTRAINT FK_NFIT1 FOREIGN KEY (COD_EMPRESA,NUM_NF) REFERENCES TB_NOTA_FISCAL(COD_EMPRESA,NUM_NF),
	CONSTRAINT FK_NFIT2 FOREIGN KEY (COD_EMPRESA,COD_MAT) REFERENCES TB_MATERIAL(COD_EMPRESA,COD_MAT)
	);
    
    --CRIACAO TABELAS PARAMETRO NUMERACAO NFE
    CREATE TABLE TB_PARAM_NFE
    (
     COD_EMPRESA INT NOT NULL PRIMARY KEY,
     NUM_NFE INT NOT NULL,
     CONSTRAINT FK_NFE1 FOREIGN KEY (COD_EMPRESA) REFERENCES TB_EMPRESA(COD_EMPRESA)
     );
    


--CRIACAO TABELAS PARAMETRO DE INSS
CREATE TABLE TB_PARAM_INSS
(
 VIGENCIA_INI DATE,
 VIGENCIA_FIM DATE,
...
(
 ...
 (  
    ...
    CONSTRAINT FK_AUDIT1 FOREIGN KEY (COD_EMPRESA,MATRICULA) REFERENCES TB_FUNCIONARIO(COD_EMPRESA,MATRICULA)
);

--ADD CAMPO LOGIN TABELA APONTAMENTOS CRIACAO APOS TABELA USUARIOS E FK
  ALTER TABLE TB_APONTAMENTOS ADD LOGIN VARCHAR2(30)NOT NULL;
 
  ALTER TABLE TB_APONTAMENTOS ADD LOTE VARCHAR2(20) NOT NULL;
...
--ADD CAMPO LOGIN TABELA ESTOQUE_MOV  CRIACAO APOS TABELA USUARIO
  ALTER TABLE TB_ESTOQUE_MOV ADD LOGIN VARCHAR2(30)NOT NULL;
  
 

--ALTERAR  COD_PAGTO TAB PED_COMPRAS PARA FOREIGN KEY APOS TABELA COND_PAGTO
  ALTER TABLE TB_PED_COMPRAS ADD 
  FOREIGN KEY (COD_PAGTO) REFERENCES TB_COND_PAGTO(COD_PAGTO);
