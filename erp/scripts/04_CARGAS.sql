-- CARGA EMPRESA
INSERT INTO TB_EMPRESA (NOME_EMPRESA,FANTASIA) VALUES ('COMPANY BIKE','BIKES');
INSERT INTO TB_EMPRESA (NOME_EMPRESA,FANTASIA) VALUES ('COMPANY CAR','CARS');

-- VERFICANDO 
SELECT * FROM TB_EMPRESA;

--CARGA PARAMETRO NFE
INSERT INTO TB_PARAM_NFE (COD_EMPRESA,NUM_NFE) VALUES (1,0);
INSERT INTO TB_PARAM_NFE (COD_EMPRESA,NUM_NFE) VALUES (2,0);

--VERFICANDO PARAM_NFE
SELECT * FROM TB_PARAM_NFE;

--CARGA PARAMETRO PARAM_PED_COMPRAS
INSERT INTO TB_PARAM_PED_COMPRAS (COD_EMPRESA,NUM_PED) VALUES (1,0);
INSERT INTO TB_PARAM_PED_COMPRAS (COD_EMPRESA,NUM_PED) VALUES (2,0);


--VERFICANDO PARAM_PED_COMPRAS
SELECT * FROM TB_PARAM_PED_COMPRAS;


--CARGA PARAMETRO PARAM_PED_COMPRAS
INSERT INTO TB_PARAM_PED_VENDAS (COD_EMPRESA,NUM_PED) VALUES (1,0);
INSERT INTO TB_PARAM_PED_VENDAS (COD_EMPRESA,NUM_PED) VALUES (2,0);


--VERFICANDO PARAM_PED_COMPRAS
SELECT * FROM TB_PARAM_PED_VENDAS;

--CARGA PARAMETRO PARAM_MATRICULA
INSERT INTO TB_PARAM_MATRICULA (COD_EMPRESA,MATRICULA) VALUES (1,0);
INSERT INTO TB_PARAM_MATRICULA (COD_EMPRESA,MATRICULA) VALUES (2,0);


--VERFICANDO PARAM_MATRICULA
SELECT * FROM TB_PARAM_MATRICULA;

--CARGA UF
--SELECT * FROM TB_UF;
--SELECT * FROM GABRIELA.ESTADOS;
INSERT INTO  TB_UF
SELECT DISTINCT E."cod_uf",E."sigla",E."estado"
	FROM gabriela.ESTADOS E;
...
SELECT * FROM gabriela.TB_CENSO ;
INSERT INTO TB_CIDADES
SELECT distinct x."cod_mun",x."cod_uf",x."nome_mun"  FROM gabriela.TB_CENSO  x;
...
SELECT * FROM TB_TIPO_MAT;
INSERT INTO TB_TIPO_MAT (DESC_TIP_MAT) VALUES ('MATERIA PRIMA');
INSERT INTO TB_TIPO_MAT (DESC_TIP_MAT) VALUES('PRODUDO ACABADO');
INSERT INTO TB_TIPO_MAT (DESC_TIP_MAT) VALUES('EMBALAGEM');
INSERT INTO TB_TIPO_MAT (DESC_TIP_MAT) VALUES('CONSUMO');
DELETE FROM TB_TIPO_MAT; 
--CARGA MATERIAL
--COD TIPO MAT
/* 
1	MATERIA PRIMA
...
INSERT INTO TB_MATERIAL VALUES	(1,1,'BICICLETA ARO 29 PRETA MOD INFINITY','2500','2');
INSERT INTO TB_MATERIAL VALUES (1,2,'BICICLETA ARO 29 BRANCA MOD INFINITY','2500','2');
INSERT INTO TB_MATERIAL VALUES (1,3,'QUADRO ARO 29','500','1');
INSERT INTO TB_MATERIAL VALUES (1,4,'KIT TRANSMISSAO','500','1');--FREIO+MARCHA-PEDEVELA-TROCADORES+K-7
INSERT INTO TB_MATERIAL VALUES	(1,5,'ARO 29','70','1');
INSERT INTO TB_MATERIAL VALUES (1,6,'PNEU 29','100','1');
INSERT INTO TB_MATERIAL VALUES (1,7,'CAMARA 29','25','1');
INSERT INTO TB_MATERIAL VALUES (1,8,'SUSPENSAO DIANTEIRA','250','1');
INSERT INTO TB_MATERIAL VALUES (1,9,'BANCO','80','1');
INSERT INTO TB_MATERIAL VALUES (1,10,'CANOTE','35','1');
INSERT INTO TB_MATERIAL VALUES (1,11,'TINTA BRANCA','10','1');
INSERT INTO TB_MATERIAL VALUES (1,12,'TINTA PRETA','10','1');
INSERT INTO TB_MATERIAL VALUES (1,13,'MESA','500','1');
INSERT INTO TB_MATERIAL VALUES (1,14,'GUIDON','50','1');
INSERT INTO TB_MATERIAL VALUES (1,15,'LUVAS','30','1');
INSERT INTO TB_MATERIAL VALUES (1,16,'CAIXA EMBALAGEM','10','3');
    
    
-- MAT_FORNEC
SELECT * FROM TB_FICHA_TECNICA;
--FICHA TENICA BIKE PRETA	
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','3',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','4',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','5',2);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','6',2);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','7',2);  
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','8',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','9',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','10',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','12',0.250);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','13',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','14',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','15',2);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'1','16',1);
--FICHA TENICA BIKE PRETA
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','3',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','4',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','5',2);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','6',2);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','7',2);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','8',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','9',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','10',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','11',0.250);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','13',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','14',1);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','15',2);
INSERT INTO TB_FICHA_TECNICA VALUES (1,'2','16',1);

SELECT * FROM TB_CENTRO_CUSTO;
--CARGA CENTRO DE CUSTOS
INSERT INTO TB_CENTRO_CUSTO VALUES (1,'9001','PRESIDENCIA');
INSERT INTO TB_CENTRO_CUSTO VALUES (1,'9002','ADMINISTRATIVO');
INSERT INTO TB_CENTRO_CUSTO VALUES (1,'9003','PRODUCAO');
INSERT INTO TB_CENTRO_CUSTO VALUES (1,'9004','SUPRIMENTOS');
INSERT INTO TB_CENTRO_CUSTO VALUES (1,'9005','RH');
INSERT INTO TB_CENTRO_CUSTO VALUES (1,'9006','FINANCEIRO');
INSERT INTO TB_CENTRO_CUSTO VALUES (1,'9007','COMERCIAL');
INSERT INTO TB_CENTRO_CUSTO VALUES (1,'9008','FISCAL');
INSERT INTO TB_CENTRO_CUSTO VALUES (1,'9009','TI');

INSERT INTO TB_CENTRO_CUSTO VALUES (2,'9001','PRESIDENCIA');
INSERT INTO TB_CENTRO_CUSTO VALUES (2,'9002','ADMINISTRATIVO');
INSERT INTO TB_CENTRO_CUSTO VALUES (2,'9003','PRODUCAO');
INSERT INTO TB_CENTRO_CUSTO VALUES (2,'9004','SUPRIMENTOS');
INSERT INTO TB_CENTRO_CUSTO VALUES (2,'9005','RH');
INSERT INTO TB_CENTRO_CUSTO VALUES (2,'9006','FINANCEIRO');
INSERT INTO TB_CENTRO_CUSTO VALUES (2,'9007','COMERCIAL');
INSERT INTO TB_CENTRO_CUSTO VALUES (2,'9008','FISCAL');
INSERT INTO TB_CENTRO_CUSTO VALUES (2,'9009','TI');

--CARGA DE CARGOS FUNCOES
SELECT * FROM TB_CARGOS;
--SELECT * FROM CENTRO_CUSTO

INSERT INTO TB_CARGOS VALUES (1,1,'PRESIDENTE');
INSERT INTO TB_CARGOS VALUES (1,2,'GER COMERCIAL');
INSERT INTO TB_CARGOS VALUES (1,3,'VENDEDOR');
INSERT INTO TB_CARGOS VALUES (1,4,'GER ADM');
INSERT INTO TB_CARGOS VALUES (1,5,'ASSINTENTE DE RH');
INSERT INTO TB_CARGOS VALUES (1,6,'OPERADOR PRODUCAO');
INSERT INTO TB_CARGOS VALUES (1,7,'ESTOQUISTA');
INSERT INTO TB_CARGOS VALUES (1,8,'ANALISTA DE SISTEMA');
INSERT INTO TB_CARGOS VALUES (1,9,'FATURISTA');
INSERT INTO TB_CARGOS VALUES (1,10,'ASSISTENTE FINANCEIRO');


INSERT INTO TB_CARGOS VALUES (2,1,'PRESIDENTE');
INSERT INTO TB_CARGOS VALUES (2,2,'GER COMERCIAL');
INSERT INTO TB_CARGOS VALUES (2,3,'VENDEDOR');
INSERT INTO TB_CARGOS VALUES (2,4,'GER ADM');
INSERT INTO TB_CARGOS VALUES (2,5,'ASSINTENTE DE RH');
INSERT INTO TB_CARGOS VALUES (2,6,'OPERADOR PRODUCAO');
INSERT INTO TB_CARGOS VALUES (2,7,'ESTOQUISTA');
INSERT INTO TB_CARGOS VALUES (2,8,'ANALISTA DE SISTEMA');
INSERT INTO TB_CARGOS VALUES (2,9,'FATURISTA');
INSERT INTO TB_CARGOS VALUES (2,10,'ASSISTENTE FINANCEIRO');
...
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'JAMESL','1','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'JONHL','2','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'PETERD','3','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'LARAP','4','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'JESSICAS','5','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'PEDROT','6','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'TIAGOF','7','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'MALCOND','8','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'CHARLESN','9','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'JOAOS','10','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'DAVIDM','11','0','A');
INSERT INTO TB_USUARIOS (COD_EMPRESA,LOGIN,MATRICULA,SENHA,SITUACAO) VALUES (2,'SAMUELD','12','0','A');
...
UPDATE TB_USUARIOS  SET SENHA=MD5(MATRICULA)  WHERE 1=1;
